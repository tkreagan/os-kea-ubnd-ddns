...
"""
stop.py -- Stop kea-ubnd-ddns and kea-ubnd-logwatch cleanly.
...
SCRIPT_PATH          = "/usr/local/sbin/kea-ubnd-ddns.py"
LOGWATCH_SCRIPT_PATH = "/usr/local/sbin/kea-ubnd-logwatch.py"
...
def main() -> int:
    ...
    ok1 = _stop_one("kea-ubnd-ddns",
                    listener_pids, (SUPERVISOR_PIDFILE, PIDFILE))
    ok2 = _stop_one("kea-ubnd-logwatch",
